...
Supported client-route retry evidence: `docs/evidence/knowledge-vault-plugin-rpc-compatibility.md` records the canonical hosted-client Direct connection attempts to both `tcp://127.0.0.1:6767` and `tcp://localhost:6767`, each timing out without credentials or bypass.
